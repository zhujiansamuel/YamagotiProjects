...
def clean_shop9(
    ...
    for i in range(len(df)):
        ...
        color_only_mode, color_only_specs = detect_color_only_filter(
            raw_combined_shop9 or raw_color_shop9, color_to_pn, _label_matches_color_unified,
            split_tokens_re=SPLIT_TOKENS_RE_shop9,
        ...
        if color_only_mode:
            ...
            decomp = PriceDecomposition(
                base_price=base_price or 0, delta_specs=co_delta_specs,
            ...
            new_rows, ctx.log_seq = resolve_color_prices(
                decomp, color_to_pn, _label_matches_color_unified,
                ...
                model_text=str(raw_model), model_norm=str(m),
                capacity_gb=c,
            )
